...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { age: @child.age, description: @child.description, gender: @child.gender, name: @child.name }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { age: @child.age, description: @child.description, gender: @child.gender, name: @child.name }
    assert_redirected_to child_path(assigns(:child))
  end
